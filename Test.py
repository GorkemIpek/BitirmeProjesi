...
def test_audio_file(model_path, scaler_path, label_path, audio_filename, model_info_path=None):
    ...
    print(
        f"Trust Level: {prediction_probs[predicted_class_index]:.4f} (%{prediction_probs[predicted_class_index] * 100:.2f})")
    print("\nProbabilites")
...
def main():
    ...
    audio_filename = input("Enter the test file name (e.g.: test.wav): ")
